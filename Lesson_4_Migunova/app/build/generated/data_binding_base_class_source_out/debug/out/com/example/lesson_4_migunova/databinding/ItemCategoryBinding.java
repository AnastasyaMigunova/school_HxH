...
public final class ItemCategoryBinding implements ViewBinding {
  ...
  private ItemCategoryBinding(@NonNull MaterialCardView rootView, @NonNull ImageView imageViewIcon,
  ...
  public static ItemCategoryBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemCategoryBinding((MaterialCardView) rootView, imageViewIcon, textViewCategory,
          textViewDescription);
    }
