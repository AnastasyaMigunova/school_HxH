...
public final class ActivityFourthBinding implements ViewBinding {
  ...
  @NonNull
  public final MaterialButton buttonFourthAgain;

  @NonNull
  public final TextView textViewTime;

  private ActivityFourthBinding(@NonNull ConstraintLayout rootView,
      @NonNull MaterialButton buttonFourthAgain, @NonNull TextView textViewTime) {
    this.rootView = rootView;
    this.buttonFourthAgain = buttonFourthAgain;
  ...
  public static ActivityFourthBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.buttonFourthAgain;
      MaterialButton buttonFourthAgain = ViewBindings.findChildViewById(rootView, id);
      if (buttonFourthAgain == null) {
        break missingId;
      }
      ...
      return new ActivityFourthBinding((ConstraintLayout) rootView, buttonFourthAgain,
          textViewTime);
    }
