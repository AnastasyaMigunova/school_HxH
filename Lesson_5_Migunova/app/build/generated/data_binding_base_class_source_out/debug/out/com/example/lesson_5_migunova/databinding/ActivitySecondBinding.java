...
public final class ActivitySecondBinding implements ViewBinding {
  ...
  @NonNull
  public final MaterialButton buttonForThird;

  private ActivitySecondBinding(@NonNull ConstraintLayout rootView,
      @NonNull MaterialButton buttonForThird) {
    this.rootView = rootView;
    this.buttonForThird = buttonForThird;
  }
  ...
  public static ActivitySecondBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.buttonForThird;
      MaterialButton buttonForThird = ViewBindings.findChildViewById(rootView, id);
      if (buttonForThird == null) {
        break missingId;
      }

      return new ActivitySecondBinding((ConstraintLayout) rootView, buttonForThird);
    }
